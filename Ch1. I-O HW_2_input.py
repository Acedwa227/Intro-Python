...
NUM_FAM1 = int(input("Enter the number of slices each person 1 eats: "))
NUM_FAM2 = int(input("Enter the number of slices each person 2 eats: "))
NUM_FAM3 = int(input("Enter the number of slices each person 3 eats: "))
NUM_FAM4 = int(input("Enter the number of slices each person 4 eats: "))

# Calculate number of slices the family requires
NEEDED_SLICES = NUM_FAM1 + NUM_FAM2 + NUM_FAM3 + NUM_FAM4 
...
# Print Results
print(f"For a family of 4, eating {NUM_FAM1}, {NUM_FAM2}, {NUM_FAM3},{NUM_FAM4} slices each:")
